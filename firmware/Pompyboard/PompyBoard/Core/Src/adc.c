  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = MUX0_OUT_Pin|MUX1_OUT_Pin|MUX2_OUT_Pin|MUX3_OUT_Pin
                          |MUX4_OUT_Pin|MUX5_OUT_Pin|MUX6_OUT_Pin|MUX7_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC5     ------> ADC2_IN15
    */
    HAL_GPIO_DeInit(GPIOA, MUX14_OUT_Pin|MUX15_OUT_Pin|MUX16_OUT_Pin);

    HAL_GPIO_DeInit(GPIOC, MUX17_OUT_Pin|MUX18_OUT_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PA3     ------> ADC3_IN3
    */
    HAL_GPIO_DeInit(GPIOF, MUX0_OUT_Pin|MUX1_OUT_Pin|MUX2_OUT_Pin|MUX3_OUT_Pin
                          |MUX4_OUT_Pin|MUX5_OUT_Pin|MUX6_OUT_Pin|MUX7_OUT_Pin);

    HAL_GPIO_DeInit(GPIOC, MUX8_OUT_Pin|MUX9_OUT_Pin|MUX10_OUT_Pin);

    HAL_GPIO_DeInit(GPIOA, MUX11_OUT_Pin|MUX12_OUT_Pin|MUX13_OUT_Pin);
